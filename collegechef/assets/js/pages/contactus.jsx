...
import {
    ...
    Button, FormGroup,Row, Label, Input, Col
} from 'reactstrap';
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-4 offset-sm-1">
                        ...
                        <address>
                            ...
                            Boston, MA, 02115<br />
                            <i className="fa fa-phone">:+1 (617) 373-2000</i><br />
                            <i className="fa fa-envelope"></i><a href="mailto:confusion@food.net">: lingashettar.p@husky.neu.edu</a>
                        </address>
                    </div>
