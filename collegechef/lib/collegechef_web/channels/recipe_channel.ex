defmodule CollegechefWeb.RecipesChannel do
    ...
    # alias CollegechefWeb.SpoonacularAPI.Spoonacular
    ...
    def handle_in("get_api_recipes", %{"searchWords" => searchWords}, socket) do
        name = socket.assigns[:name]
        recipes = GetRecipes.getRecipeByIngredients(socket.assigns[:recipes], searchWords)
        socket = assign(socket, :recipes, recipes)
        {:reply, {:ok, %{ "recipes" => GetRecipes.client_view(recipes)}}, socket}
    end
